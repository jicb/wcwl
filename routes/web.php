...
Route::group(['as'=>'button::','prefix'=>'button','namespace'=>'Wechat\Button'],function(){
    ...
    Route::any('myself/recharge',['as'=>'recharge','uses'=>'MyselfController@recharge']);
    Route::any('myself/gopay',['as'=>'gopay','uses'=>'MyselfController@gopay']);
    ...
    Route::any('myself/ordercashpay',['as'=>'ordercashpay','uses'=>'MyselfController@ordercashpay']);
    Route::any('myself/sendedsure',['as'=>'sendedsure','uses'=>'MyselfController@sendedsure']);
